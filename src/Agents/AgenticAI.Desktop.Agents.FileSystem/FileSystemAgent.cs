...
public class FileSystemAgent : BaseAgent
{
        ...
        : base(logger, configuration, "FileSystem Agent", "Handles file and directory operations with security restrictions")
    {
        ...
        _maxFileSize = configuration.GetValue<long?>("FileSystemAgent:MaxFileSize") ?? 10L * 1024L * 1024L; // 10MB default
    ...
    {
        _capabilitiesList.AddRange(new[]
        {
            new AgentCapability
            {
                Name = "read_file",
        ...
        Metadata["allowed_extensions"] = _allowedExtensions != null ? string.Join(", ", _allowedExtensions) : "";
